...
const connectDB = async () => {
  try {
    ...
    // Create indexes
    await mongoose.connection.db.collection("activities").createIndex({ userId: 1, createdAt: -1 });
    await mongoose.connection.db.collection("testsessions").createIndex({ userId: 1, createdAt: -1 });
